...
export type InvestorHoldingDetailScreenNavigationProps = CompositeScreenProps<
...
const InvestorHoldingDetailScreen: FC<InvestorHoldingDetailScreenNavigationProps> = ({ navigation, route }) => {
  ...
  return (
    <ScreenBackgrounds screenName={RouteStacks.investorHoldingDetail}>
      <Header
        headerText={t('investorHoldingDetail')}
        onLeftPress={() => navigation.navigate(RouteStacks.investorHoldingList)}
        withProfile={false}
      />
