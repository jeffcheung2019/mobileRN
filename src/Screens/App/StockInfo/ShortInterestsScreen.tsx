...
export type ShortInterestsScreenNavigationProps = CompositeScreenProps<
  StackScreenProps<StockInfoStackNavigatorParamList, RouteStacks.shortInterests>,
  StockInfoStackNavigationProps
>

const ShortInterestsScreen: FC<ShortInterestsScreenNavigationProps> = ({ navigation, route }) => {
