...
export type ShortResearchReportsDetailScreenProps = CompositeScreenProps<
  StackScreenProps<StockInfoScreenNavigatorParamList, RouteStacks.usEconomicData>,
  StockInfoStackScreenProps
>

const ShortResearchReportsDetailScreen: FC<ShortResearchReportsDetailScreenProps> = ({ navigation, route }) => {
...
export default ShortResearchReportsDetailScreen
