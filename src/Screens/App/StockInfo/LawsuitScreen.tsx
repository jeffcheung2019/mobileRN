...
export type LawsuitScreenNavigationProps = CompositeScreenProps<
  StackScreenProps<StockInfoStackNavigatorParamList, RouteStacks.lawsuit>,
  StockInfoStackNavigationProps
>

const LawsuitScreen: FC<LawsuitScreenNavigationProps> = ({ navigation, route }) => {
  const { t } = useTranslation()
  const { Common, Fonts, Gutters, Layout } = useTheme()
  const dispatch = useDispatch()

  return (
    <ScreenBackgrounds screenName={RouteStacks.lawsuit}>
      <Header headerText={t('lawsuit')} onLeftPress={() => navigation.navigate(RouteStacks.stockInfoMain)} withProfile={false} />
