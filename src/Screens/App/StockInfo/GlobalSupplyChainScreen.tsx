...
export type GlobalSupplyChainScreenNavigationProps = CompositeScreenProps<
...
const GlobalSupplyChainScreen: FC<GlobalSupplyChainScreenNavigationProps> = ({ navigation, route }) => {
