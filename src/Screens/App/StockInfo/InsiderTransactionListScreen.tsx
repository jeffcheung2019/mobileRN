...
const InsiderTransactionListScreen: FC<InsiderTransactionListScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScreenBackgrounds screenName={RouteStacks.insiderTransactionList}>
      <Header
        headerText={t('insiderTransactions')}
        onLeftPress={() => {
          navigation.navigate(RouteStacks.stockInfoMain)
        }}
        withProfile={false}
      />
...
export default InsiderTransactionListScreen
