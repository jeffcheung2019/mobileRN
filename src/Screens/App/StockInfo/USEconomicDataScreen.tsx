...
export type USEconomicDataScreenNavigationProps = CompositeScreenProps<
  StackScreenProps<StockInfoStackNavigatorParamList, RouteStacks.usEconomicData>,
  StockInfoStackNavigationProps
>

const USEconomicDataScreen: FC<USEconomicDataScreenNavigationProps> = ({ navigation, route }) => {
